...
This demonstrates the bug that I caught today. Normally, a `TextField` inside a `SingleChildScrollView` scrolls into view when the keyboard appears after getting focus. It fails to scroll into view under these conditions: 
